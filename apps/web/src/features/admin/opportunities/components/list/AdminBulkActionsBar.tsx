            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-4">
                ...
                <div className="grid grid-cols-2 gap-1 sm:flex sm:flex-wrap sm:items-center">
                    <button
                        ...
                        className="h-8 px-3 text-xs font-semibold text-success hover:bg-success/50 rounded-md transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                    ...
                    <button
                        ...
                        disabled={bulkActionPending}
                        className="h-8 px-3 text-xs font-semibold text-warning hover:bg-warning/50 rounded-md transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                    ...
                    <button
                        ...
                        disabled={bulkActionPending}
                        className="h-8 px-3 text-xs font-semibold text-error hover:bg-error/50 rounded-md transition-colors disabled:opacity-60 disabled:cursor-not-allowed col-span-2 sm:col-span-1"
                    >
