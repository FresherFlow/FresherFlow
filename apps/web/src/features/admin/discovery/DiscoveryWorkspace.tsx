...
export function DiscoveryWorkspace() {
 ...
 const getTabTitle = (tabId: string) => {
   switch (tabId) {
     ...
     case 'runs': return 'Discovery Runs';
     case 'discovered': return 'Discovered Jobs';
     case 'processed': return 'Processed Jobs Queue';
     case 'companies': return 'Target Companies';
     case 'adapters': return 'ATS Adapters';
     case 'boards': return 'Job Boards';
     default: return 'Discovery Engine';
   }
 };
 ...
 <div className="flex-1 overflow-hidden p-2 pt-3 sm:p-6 flex flex-col min-h-0">
 <div key={activeTab} className="animate-in fade-in duration-150 flex flex-col flex-1 min-h-0 w-full">
 {activeTab === 'dashboard' && (
 <DashboardTab
