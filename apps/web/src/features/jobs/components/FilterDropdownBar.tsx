...
const chipBase = 'h-9 px-3 rounded-lg text-sm font-semibold flex items-center gap-1.5 transition-all duration-150 ease-out active-press whitespace-nowrap select-none cursor-pointer outline-none motion-reduce:transform-none motion-reduce:transition-none';
        ...
        <div ref={barRef} className="hidden lg:flex items-center gap-1 flex-wrap">
            ...
            {onTypeChange && (
                <div className="relative" onMouseLeave={closeOnLeave}>
                    ...
                    {open === 'type' && (
                        <div className="absolute right-0 top-full mt-2 before:absolute before:-top-2 before:inset-x-0 before:h-2 before:content-empty bg-card border border-border rounded-xl shadow-lg animate-in fade-in-0 zoom-in-95 duration-150 origin-top p-1.5 w-48 z-overlay overscroll-contain">
            ...
            <div className="relative" onMouseLeave={closeOnLeave}>
                ...
                {open === 'location' && (() => {
                    let itemIdx = 0;
                    return (
                        <div className="absolute right-0 top-full mt-2 before:absolute before:-top-2 before:inset-x-0 before:h-2 before:content-empty bg-card border border-border rounded-xl shadow-xl animate-in fade-in-0 zoom-in-95 duration-150 origin-top p-2 w-72 z-overlay space-y-1.5 overscroll-contain">
                            <div className="px-1">
                                <input
                                    type="text"
                                    value={locSearch}
            ...
            {isGovt && (
                <>
                    <div className="relative" onMouseLeave={closeOnLeave}>
                        ...
                        {open === 'sector' && (
                            <div className="absolute right-0 top-full mt-2 before:absolute before:-top-2 before:inset-x-0 before:h-2 before:content-empty bg-card border border-border rounded-xl shadow-lg animate-in fade-in-0 zoom-in-95 duration-150 origin-top p-2 w-52 z-overlay">
            ...
            {!isGovt && (
                <>
                    ...
                    <div className="relative" onMouseLeave={closeOnLeave}>
                        ...
                        {open === 'role' && (
                            <div className="absolute right-0 top-full mt-2 before:absolute before:-top-2 before:inset-x-0 before:h-2 before:content-empty bg-card border border-border rounded-xl shadow-lg animate-in fade-in-0 zoom-in-95 duration-150 origin-top p-2 w-64 z-overlay flex flex-col gap-1 max-h-80">
                    ...
                    <div className="relative" onMouseLeave={closeOnLeave}>
                        ...
                        {open === 'skills' && (
                            <div className="absolute right-0 top-full mt-2 before:absolute before:-top-2 before:inset-x-0 before:h-2 before:content-empty bg-card border border-border rounded-xl shadow-lg animate-in fade-in-0 zoom-in-95 duration-150 origin-top p-2 w-72 min-w-72 z-overlay flex flex-col gap-1 max-h-80">
                                <div className="px-1 pb-1 pt-0.5 shrink-0">
                                    <input
                                        type="text"
                                        value={skillSearch}
                                ...
                                <div className="overflow-y-auto flex-1 overscroll-contain">
                                    {filteredSkills.map(({ skill, count }, idx) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <input type="checkbox" tabIndex={-1} checked={!!isSelected} readOnly className="w-4 h-4 rounded border-border text-primary focus:ring-primary accent-primary pointer-events-none shrink-0" />
                                                <SkillPill skill={skill} variant="bare" />
                    ...
                    <div className="relative" onMouseLeave={closeOnLeave}>
                        ...
                        {open === 'year' && (() => {
                            let itemIdx = 0;
                            return (
                                <div className="absolute right-0 top-full mt-2 before:absolute before:-top-2 before:inset-x-0 before:h-2 before:content-empty bg-card border border-border rounded-xl shadow-lg animate-in fade-in-0 zoom-in-95 duration-150 origin-top p-2 w-44 z-overlay">
                                    {(() => {
                                        const idx = itemIdx++;
                                        return (
                                            <button
