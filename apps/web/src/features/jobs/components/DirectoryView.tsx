...
export function DirectoryView({ title, description, data, urlPrefix, entityType = 'default' }: DirectoryClientProps) {
...
/** @deprecated Use DirectoryView — DirectoryClient is kept for one release as a shim. */
export const DirectoryClient = DirectoryView;
