                    ...
                    <div className="flex gap-2.5 overflow-x-auto pb-1.5 -mx-1 px-1 snap-x snap-mandatory scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent">
                        {items.map((opp) => (
                            <Link
                                ...
                                href={`/jobs/${opp.slug}`}
                                className="snap-start shrink-0 w-60 p-3 rounded-xl border border-border bg-card hover:border-primary/40 hover:shadow-sm transition-all flex flex-col gap-1.5 group active:scale-[0.98] duration-150 ease-out motion-reduce:transform-none"
                            >
