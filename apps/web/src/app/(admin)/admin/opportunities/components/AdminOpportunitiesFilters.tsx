    ...
    <div className="flex items-center gap-2 flex-wrap w-full">
        ...
        {selectedCount > 0 && (
            <div className="flex items-center gap-2 flex-wrap animate-in fade-in slide-in-from-left-2 duration-150">
                <span className="w-6 h-6 rounded-full bg-primary text-primary-foreground text-xs font-bold flex items-center justify-center shrink-0">{selectedCount}</span>
        ...
        <div className="flex items-center gap-2 ml-auto">
            ...
            {(typeFilter || statusFilter || sort !== 'postedAt_desc') && (
                <Button variant="admin" size="sm" onClick={onClear}>
                    Clear
                </Button>
            )}
        </div>
