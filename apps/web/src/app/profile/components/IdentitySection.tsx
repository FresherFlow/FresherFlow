        ...
        <CompactSection
            ...
            viewContent={
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <p className="text-[11px] font-semibold text-muted-foreground capitalize tracking-wider mb-1">Full Name</p>
                        <p className="text-sm md:text-base font-medium text-foreground">{fullName || <span className="opacity-50 italic">Not set</span>}</p>
                    </div>
                    <div>
                        <p className="text-[11px] font-semibold text-muted-foreground capitalize tracking-wider mb-1">Verified Email</p>
