...
import { usePostOpportunityForm } from './post-opportunity/usePostOpportunityForm';
import { ParseModal } from './post-opportunity/ParseModal';
...
export const PostOpportunityScreen = ({ route, navigation }: any) => {
    ...
    const { form, set, toggle, fillForm, loading, saving, handleSave } =
        usePostOpportunityForm(opportunityId, navigation);
