...
export const opportunitySchema = z.object({
    ...
    governmentJobDetails: z.object({
        ...
        examCenters: z.array(z.string()).optional().default([]),
        examPattern: z.any().optional(),
        skillTests: z.any().optional(),
        examStages: z.any().optional(),
        importantDates: z.any().optional(),
        qualificationDetails: z.any().optional(),
        physicalStandards: z.any().optional(),
        extraMetadata: z.any().optional(),
        feeBreakdown: z.any().optional(),
        ageRelaxationRules: z.any().optional(),
        notificationPdfUrl: z.string().url().optional().or(z.string().length(0)),
        admitCardUrl: z.string().url().optional().or(z.string().length(0)),
        resultUrl: z.string().url().optional().or(z.string().length(0)),
        answerKeyUrl: z.string().url().optional().or(z.string().length(0)),
        syllabusUrl: z.string().url().optional().or(z.string().length(0)),
        previousPapersUrl: z.string().url().optional().or(z.string().length(0)),
        vacancyBreakdown: z.any().optional(),
        governmentLevel: z.string().optional(),
        vacancyNature: z.string().optional(),
        applicationStatus: z.string().optional(),
        jobCategory: z.array(z.string()).optional(),
