        ...
        <View style={[
            ...
            {badge.unlocked && (
                <View style={[styles.unlockedTag, { backgroundColor: currentTheme.colors.success }]}>
                    <CheckCircle2 size={mScale(10)} color={currentTheme.colors.inverseText} />
                </View>
            )}
        </View>
    );
        ...
        <Screen safe={false}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <SurfaceCard style={styles.codeCard}>
                    <Text style={[styles.codeTitle, { color: currentTheme.colors.textMuted }]}>Your Invite Code</Text>
                    <View style={styles.codeRow}>
                        <Text style={[styles.codeText, { color: currentTheme.colors.text }]}>{referralCode || '------'}</Text>
                        <TouchableOpacity onPress={copyToClipboard} style={[styles.copyBtn, { backgroundColor: alpha(currentTheme.colors.text, 0.05) }]}>
                ...
                <View style={styles.sectionHeader}>
                    <Text style={[styles.sectionTitle, { color: currentTheme.colors.textMuted }]}>Invite Badges</Text>
                ...
                {/* 4. Recent Joinees */}
                <View style={styles.sectionHeader}>
                    <Text style={[styles.sectionTitle, { color: currentTheme.colors.textMuted }]}>Recent Joinees</Text>
                </View>
                <SurfaceCard style={styles.referralsList}>
                    {referrals && referrals.length > 0 ? (
                        ...
                        <View style={styles.emptyReferrals}>
                            ...
                            <Text style={[styles.emptyText, { color: currentTheme.colors.textMuted }]}>No invites yet. Start sharing!</Text>
                        </View>
                    )}
                </SurfaceCard>
            </ScrollView>
