...
import { ShieldCheck, ExternalLink, Send, MessageSquare, Share2 as LucideShare, Code as LucideCode } from 'lucide-react-native';
const Github = LucideCode;
const Twitter = LucideShare;
const Linkedin = LucideShare;
const Instagram = LucideShare;
const Facebook = LucideShare;
