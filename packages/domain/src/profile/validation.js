 ...
 */
function validateEducationData(input) {
    const { fullName, requireFullName, educationLevel, tenthYear, twelfthYear, gradCourse, gradSpecialization, gradYear, hasPG, pgCourse, pgSpecialization, pgYear, } = input;
